...
INTEGER, ALLOCATABLE, DIMENSION(:) :: REQ,REQ1,REQ2,REQ3,REQ4,REQ5,REQ7,REQ6,REQ8,REQ9,REQ10,REQ11,REQ12,REQ14,REQ15,&
                                      COUNTS,DISPLS,COUNTS_MASS,DISPLS_MASS,COUNTS_HVAC,DISPLS_HVAC,&
                                      COUNTS_QM_DOT,DISPLS_QM_DOT,COUNTS_TEN,DISPLS_TEN,COUNTS_TWENTY,DISPLS_TWENTY
INTEGER :: N_REQ,N_REQ1=0,N_REQ2=0,N_REQ3=0,N_REQ4=0,N_REQ5=0,N_REQ7=0,N_REQ6=0,N_REQ8=0,N_REQ9=0,N_REQ10=0,N_REQ11=0,N_REQ12=0,&
           N_REQ14=0,N_REQ15=0,N_COMMUNICATIONS
...
INTEGER :: NN1,NN2,IPC,CNT,IBC,STORAGE_INDEX_SAVE,II1,II2,JJ1,JJ2,KK1,KK2,NQT2,NN,IOR,NRA,NRA_MAX,AIC,OBST_INDEX
...
IF (N_MPI_PROCESSES>1 .AND. (CODE==0 .OR. CODE==12) .AND. N_REQ9>0) THEN
   CALL MPI_STARTALL(N_REQ9,REQ9(1:N_REQ9),IERR)
   CALL TIMEOUT('REQ9',N_REQ9,REQ9(1:N_REQ9))
   CALL MPI_STARTALL(N_REQ10,REQ10(1:N_REQ10),IERR)
   CALL TIMEOUT('REQ10',N_REQ10,REQ10(1:N_REQ10))
   CALL MPI_STARTALL(N_REQ11,REQ11(1:N_REQ11),IERR)
   CALL TIMEOUT('REQ11',N_REQ11,REQ11(1:N_REQ11))
   CALL MPI_STARTALL(N_REQ12,REQ12(1:N_REQ12),IERR)
   CALL TIMEOUT('REQ12',N_REQ12,REQ12(1:N_REQ12))
ENDIF
   ...
   RECV_MESH_LOOP: DO NM=1,NMESHES
      ...
      IF (CODE==16 .AND. M2%N_INTERNAL_OBST>0) THEN
         DO N=1,M2%N_INTERNAL_OBST
            ...
            M4%OBSTRUCTION(OBST_INDEX)%MASS = M4%OBSTRUCTION(OBST_INDEX)%MASS - M2%REAL_RECV_PKG8(2*N)
         ENDDO
      ENDIF
      ...
      IF (CODE==17 .AND. M2%N_INTERNAL_OBST>0) THEN
         DO N=1,M2%N_INTERNAL_OBST
            ...
            M2%REAL_SEND_PKG8(2*N)   = M4%OBSTRUCTION(OBST_INDEX)%MASS
         ENDDO
      ENDIF
      ...
      IF (CODE==18 .AND. M2%N_EXTERNAL_OBST>0) THEN
         DO N=1,M2%N_EXTERNAL_OBST
            OBST_INDEX = NINT(M2%REAL_RECV_PKG8(2*N-1))
            M%OBSTRUCTION(OBST_INDEX)%MASS = M2%REAL_RECV_PKG8(2*N)
         ENDDO
